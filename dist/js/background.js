...
function onAskForPin() {
  if (myPin) {
    setTimeout(() => {
      js_utils_utils_eventBus__WEBPACK_IMPORTED_MODULE_0__.default.trigger('set-pin-from-bg', myPin);
    });
  }
}

js_utils_utils_eventBus__WEBPACK_IMPORTED_MODULE_0__.default.on('ask-for-pin', onAskForPin).on('pin-success', onPinSuccess);
